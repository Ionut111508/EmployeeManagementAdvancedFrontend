...
export function CreateAllocationPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      setMessage('Alocarea a fost creata.');
    } catch (err) { setMessage(err instanceof Error ? err.message : 'Eroare la creare.'); }
  }

  return <section className="page-stack">
    <PageHeader eyebrow="Planning" title="Create allocation" description="Alege manual angajatul sau lasa aplicatia sa aleaga automat." />
