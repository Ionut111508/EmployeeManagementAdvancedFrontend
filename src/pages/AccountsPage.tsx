...
const emptyCreateForm = { accountId: '', username: '', password: '' };
...
export function AccountsPage() {
  ...
  async function createAccount(event: FormEvent) {
    ...
    try {
      ...
      setMessage('Employee account created. Link it to an employee, then promote it from Roles if needed.');
    } catch (error) {
  ...
  return <section className="page-stack">
    <PageHeader eyebrow="Security" title="Accounts" description="Create employee accounts and reset credentials. Role and project access are managed separately from Roles." />
